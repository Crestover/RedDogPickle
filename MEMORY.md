...
- **Pending migrations:** none — `m18.0_padel_target_points.sql` confirmed applied to both dev and production Supabase (2026-09-21; includes `7` in the CHECK allowed-values list, added when applying to prod). `m16.0` and `m17.0` also confirmed applied to both (verified 2026-09-19).
