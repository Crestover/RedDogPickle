  ...
  return (
    <div className="space-y-4">
      ...
      <div className="space-y-3">
        {/* Row 1: Court count (left) + Void Last Game (right) */}
        ...
        <button
          ...
          className="flex w-full items-center justify-center rounded-lg bg-green-600 px-3 py-2.5 text-sm font-semibold text-white hover:bg-green-700 active:bg-green-800 transition-colors disabled:opacity-40"
        >
